...
class EMMAEngine:
    ...
    def _static_template(self, sector: str) -> dict:
        ...
        defaults = {
            ...
            # Essential-service municipal infrastructure — investment-grade,
            # tax-exempt revenue bonds. Materially different risk/coupon
            # profile than corporate_ma; must not fall back to its 7-10%
            # high-yield band. Sector keys match SECTOR_NAICS_MAP above.
            "water_sewer": {
                "par_range": {"min": 15_000_000, "max": 250_000_000, "median": 60_000_000},
                "coupon_range": {"min": 3.50, "max": 5.50, "median": 4.25},
                "typical_amortization": "level_debt_service",
                "typical_tax_status": "tax_exempt",
                "typical_enhancement": "none",
                "security_type": "revenue_bond",
                "covenant_package": {"dscr_threshold": 1.20, "additional_bonds_test": "1.20x historical"},
                "reserves": {"dsrf_type": "mads"},
                "call_schedule": {"nc_period_years": 10, "par_call_after": True},
                "maturity_years": 30,
            },
            "electric_power": {
                "par_range": {"min": 20_000_000, "max": 400_000_000, "median": 75_000_000},
                "coupon_range": {"min": 3.75, "max": 5.50, "median": 4.50},
                "typical_amortization": "level_debt_service",
                "typical_tax_status": "tax_exempt",
                "typical_enhancement": "none",
                "security_type": "revenue_bond",
                "covenant_package": {"dscr_threshold": 1.10, "additional_bonds_test": "1.10x projected"},
                "reserves": {"dsrf_type": "mads"},
                "call_schedule": {"nc_period_years": 10, "par_call_after": True},
                "maturity_years": 30,
            },
            "airports": {
                "par_range": {"min": 25_000_000, "max": 500_000_000, "median": 100_000_000},
                "coupon_range": {"min": 4.00, "max": 5.75, "median": 4.75},
                "typical_amortization": "level_debt_service",
                "typical_tax_status": "tax_exempt",
                "typical_enhancement": "bond_insurance",
                "security_type": "revenue_bond",
                "covenant_package": {"dscr_threshold": 1.25, "additional_bonds_test": "1.25x projected"},
                "reserves": {"dsrf_type": "mads"},
                "call_schedule": {"nc_period_years": 10, "par_call_after": True},
                "maturity_years": 30,
            },
            "toll_roads": {
                "par_range": {"min": 50_000_000, "max": 750_000_000, "median": 150_000_000},
                "coupon_range": {"min": 4.25, "max": 6.25, "median": 5.00},
                "typical_amortization": "sculpted",
                "typical_tax_status": "tax_exempt",
                "typical_enhancement": "bond_insurance",
                "security_type": "revenue_bond",
                "covenant_package": {"dscr_threshold": 1.30, "additional_bonds_test": "1.30x projected"},
                "reserves": {"dsrf_type": "mads"},
                "call_schedule": {"nc_period_years": 10, "par_call_after": True},
                "maturity_years": 30,
            },
            "solid_waste": {
                "par_range": {"min": 10_000_000, "max": 150_000_000, "median": 40_000_000},
                "coupon_range": {"min": 4.50, "max": 6.50, "median": 5.25},
                "typical_amortization": "level_debt_service",
                "typical_tax_status": "tax_exempt",
                "typical_enhancement": "none",
                "security_type": "revenue_bond",
            ...
            "higher_education": {
                "par_range": {"min": 15_000_000, "max": 250_000_000, "median": 50_000_000},
                "coupon_range": {"min": 4.00, "max": 6.00, "median": 5.00},
                "typical_amortization": "level_debt_service",
                "typical_tax_status": "tax_exempt",
                "typical_enhancement": "none",
                "security_type": "pab_501c3",
                "covenant_package": {"dscr_threshold": 1.20, "additional_bonds_test": "1.20x projected"},
                "reserves": {"dsrf_type": "mads"},
                "call_schedule": {"nc_period_years": 10, "par_call_after": True},
                "maturity_years": 30,
            },
            "hotels_hospitality": {
                "par_range": {"min": 10_000_000, "max": 200_000_000, "median": 40_000_000},
                "coupon_range": {"min": 7.00, "max": 9.50, "median": 8.00},
                "typical_amortization": "level_debt_service",
                "typical_tax_status": "taxable",
                "typical_enhancement": "none",
                "security_type": "revenue_bond",
                "covenant_package": {"dscr_threshold": 1.35, "additional_bonds_test": "1.35x projected"},
                "reserves": {"dsrf_type": "mads", "cap_i_months": 12},
                "call_schedule": {"nc_period_years": 5, "step_down_premium": True},
                "maturity_years": 15,
            },
            "market_rate_multifamily": {
                "par_range": {"min": 10_000_000, "max": 150_000_000, "median": 35_000_000},
                "coupon_range": {"min": 5.00, "max": 7.00, "median": 6.00},
                "typical_amortization": "level_debt_service",
                "typical_tax_status": "taxable",
                "typical_enhancement": "none",
                "security_type": "revenue_bond",
            ...
            "data_centers": {
                "par_range": {"min": 20_000_000, "max": 300_000_000, "median": 75_000_000},
                "coupon_range": {"min": 5.50, "max": 7.50, "median": 6.50},
                "typical_amortization": "level_debt_service",
                "typical_tax_status": "taxable",
                "typical_enhancement": "none",
                "security_type": "revenue_bond",
                "covenant_package": {"dscr_threshold": 1.25, "additional_bonds_test": "1.25x projected"},
                "reserves": {"dsrf_type": "mads", "cap_i_months": 12},
                "call_schedule": {"nc_period_years": 7, "step_down_premium": True},
                "maturity_years": 20,
            },
            "manufacturing": {
                "par_range": {"min": 10_000_000, "max": 200_000_000, "median": 40_000_000},
            ...
            # General municipal (GO / municipal revenue) — investment-grade,
            # tax-exempt. Distinct from any single-project revenue sector above.
            "municipal": {
                "par_range": {"min": 10_000_000, "max": 300_000_000, "median": 50_000_000},
                "coupon_range": {"min": 3.50, "max": 5.00, "median": 4.25},
                "typical_amortization": "level_debt_service",
                "typical_tax_status": "tax_exempt",
                "typical_enhancement": "none",
                "security_type": "general_obligation",
                "covenant_package": {"dscr_threshold": 1.20, "additional_bonds_test": "1.20x historical"},
                "reserves": {"dsrf_type": "mads"},
                "call_schedule": {"nc_period_years": 10, "par_call_after": True},
                "maturity_years": 25,
        ...
        defaults["corporate"] = defaults["corporate_ma"]

        # Truly unmapped/"other" sectors get a conservative generic muni
        # default, not corporate_ma's 7-10% high-yield band — that band is
        # only appropriate for actual taxable corporate/M&A structures.
        template = defaults.get(sector) or defaults["municipal"]
        return {
            "sector": sector,
            "sample_size": 0,
            "source": "Operating Framework static defaults" if sector in defaults else "generic municipal default (unmapped sector)",
            "template": template,
            "generated_at": datetime.utcnow().isoformat(),
        }
